...
3. **The early bonus is measured from the Google Form receipt, NOT from any commit.**
   ...
   until 22:00 — commit as often as you like. What buys the bonus is the team leader
   submitting the form early, and only once at least 3 of the 4 required items pass on
   BOTH problems. The 21:15 freeze is a *merge* freeze: it exists to leave 45 minutes for
   the README proof lines, EVENT.md, evaluation-manifest.json, LICENSES.md, making the
   repo public and the phone smoke test. After 21:15, only fixes the integrator asks for.
...
This repo is P08: shinzuu U1 and integrator, Rimjhim U2, Robiul U3, Dip U4.
