...
- **Still needed from the operator: the four registered names for `evaluation-manifest.json`.** Contributions and evidence paths are filled; only `registered_name` is a placeholder.
