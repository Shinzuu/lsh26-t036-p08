      ...
      <div className="border-b border-ink-300 bg-ink-50/50 px-4 py-3">
        ...
        <div className="mt-1 flex items-center gap-2">
          <input
            ...
            autoComplete="off"
            className="min-w-0 flex-1 rounded-card border border-ink-300 bg-white px-3 py-1.5 text-sm text-ink-900 placeholder:text-ink-500"
          />
          {searching && (
            <button
              type="button"
              onClick={() => setQuery('')}
              className="shrink-0 rounded-card border border-ink-300 px-2.5 py-1.5 text-xs font-medium text-ink-700 hover:bg-ink-100"
            >
              Clear
            </button>
          )}
